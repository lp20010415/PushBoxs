...
namespace PushBoxs
{
    ...
    public partial class FormSc : Form
    {
        ...
        private string[,] GetMapData = null;//地图数据
            ...
            switch (((Form)sender).Text)
            {
                case "已做的地图":
                    ...
                    try
                    {
                        ...
                        MapData = new string[getRow, 3];
                        SqlDataReader reader = comm.ExecuteReader();
                        while (reader.Read())
                        {
                            MapData[k, 0] = reader["Name"].ToString();
                            MapData[k, 1] = reader["MapData"].ToString();
                        ...
                        xNum = 0;
                        yNum = 0;
                        GetMapCount = MapData.GetLength(0);
                        for (int num = 0; num < GetMapCount; num++)
                        {
                            string SurfaceName = MapData[num, 2];
                            ...
                            for (int i = 0;i < 15;i++)
                            {
                                string code = MapData[num, 1].Substring(i * 30, 30);
                                for (int j = 0;j < 15;j++)
                                {
